      ...
      <div className="q-card flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 sm:p-6 rounded-3xl bg-white border border-slate-200/80 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="text-xl sm:text-2xl font-black text-[#2D3436] tracking-tight">Kelompok Belajar</h1>
            <p className="text-xs sm:text-sm font-medium text-[#636E72] mt-0.5">Kelola kelompok sifir/kelas dan penempatan santri secara terpadu.</p>
          </div>
        </div>
