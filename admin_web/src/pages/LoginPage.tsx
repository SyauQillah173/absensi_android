  ...
  return (
    <main className="relative h-[100dvh] w-full flex items-center justify-center p-3 sm:p-5 bg-[#FFDC80] dark:bg-[#0B1120] font-sans select-none overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-[380px] sm:max-w-[400px]">
        {/* CARD CONTAINER (CLEAN WHITE 3D CARD, RICH SHADOW ON DARK CANVAS) */}
        <div
          className="w-full rounded-[36px] sm:rounded-[44px] bg-[#f8fafc] px-6 py-6 sm:px-8 sm:py-8 transition-all duration-300 dark:shadow-[0_25px_60px_-12px_rgba(0,0,0,0.6)]"
          style={{
