...
const allMenu: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Koneksi WhatsApp Bot", page: "whatsapp", icon: MessageSquare },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Jadwal Ngaji Subuh & Sore", page: "absensi", absensiTab: "jadwal-ngaji", icon: LibraryBig },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Input Presensi Ngaji", page: "absensi", absensiTab: "ngaji", icon: BookOpen },
      ...
      return [
        ...
        },
        {
          ...
          children: [
            ...
            { label: "Koneksi WhatsApp Bot", page: "whatsapp" as PageKey, icon: MessageSquare },
          ...
          <footer className="mt-8 pt-5 pb-3 border-t border-[#138F81]/15 dark:border-slate-800 text-[#2D3436] dark:text-slate-400 print:hidden">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
              <div>
                ...
                <p className="text-[11px] font-semibold text-[#636E72] dark:text-slate-400">
                  Managed & Engineered by <span className="font-extrabold text-[#138F81] dark:text-[#2DD4BF] tracking-wide">IT QOMARUDDIN ( ITQOM )</span>
                </p>
              </div>

              <div className="flex items-center gap-2.5 text-[11px] font-bold">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/90 dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 shadow-2xs">
                  <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-[10px] font-extrabold text-slate-700 dark:text-slate-300">Production Live</span>
                </span>
                <span className="text-[11px] font-semibold text-[#636E72] dark:text-slate-400">
