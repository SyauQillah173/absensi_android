...
class PaymentVerificationController extends Controller
{
    ...
    public function storeWali(Request $request)
    {
        ...
        $verification = PaymentVerification::create([
            ...
            'bank_tujuan' => (\App\Models\DocumentSetting::query()->first()?->bank_sub_name ?: \App\Models\DocumentSetting::query()->first()?->bank_name) ?: 'BSI Syariah',
            'nomor_rekening_tujuan' => \App\Models\DocumentSetting::query()->first()?->bank_account_number ?: '7171 2026 88',
