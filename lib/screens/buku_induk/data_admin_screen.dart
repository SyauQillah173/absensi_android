...
class _DataAdminScreenState extends State<DataAdminScreen>
  ...
  Future<void> _loadUsers({bool forceRefresh = false}) async {
    ...
    if (cached is Map<String, dynamic> &&
      ...
      setState(() {
        _adminList = List<Map<String, dynamic>>.from(cached['data'] ?? []);
        _isLoading = false;
        _isOfflineMode = true;
      });
    }
    ...
    try {
      ...
      if (!mounted) return;
      setState(() {
        _adminList = List<Map<String, dynamic>>.from(result['data'] ?? []);
        _isLoading = false;
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Column(
          ...
          children: [
            ...
            Text('Aturan penting:'),
            SizedBox(height: 6),
            Text('- role hanya boleh admin, guru, atau wali'),
                  ...
                  child: Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 6),
                        Text(
                          'Admin: full akses kelola data utama dan user.\nGuru: fokus absensi, kelas, mapel, dan monitoring pembelajaran.\nWali: monitoring absensi, pembayaran, nilai, dan informasi anak.',
                          style: TextStyle(
                            fontSize: 9,
                            color: Color(0xFF636E72),
                            height: 1.5,
