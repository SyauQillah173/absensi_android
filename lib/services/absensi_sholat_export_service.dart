...
class AbsensiSholatExportService {
  static Future<void> exportRekapExcel({
    ...
    final values = [
      TextCellValue('Total'),
      FormulaCellValue(
        'COUNTIF(J5:J$dataEnd,"Masuk")+COUNTIF(J5:J$dataEnd,"M")',
      ),
      FormulaCellValue(
    ...
    if (bytes == null) {
      throw Exception('Gagal membuat file Excel rekap sholat');
    }
