...
class LocalDbService {
  ...
  static Future<Database> _initDatabase() async {
    ...
    return await openDatabase(
      path,
      version: 9, // v9: scope skripsi hanya queue presensi Madin
      ...
      onUpgrade: (db, oldVersion, newVersion) async {
        ...
        if (oldVersion < 9) {
          await db.execute('DROP TABLE IF EXISTS absensi_sholat_pending');
        }
      },
    );
  }
  ...
  static String buildAttendanceKey(Map<String, dynamic> data) {
    ...
    final jadwalId = data['jadwal_id'] ?? 0;
    ...
    if (tanggal.isEmpty ||
        ...
        siswaId == null) {
      throw ArgumentError(
        'Absensi offline wajib punya tanggal, class_id, mapel_id, dan siswa_id.',
      );
    }
